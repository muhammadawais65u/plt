...
export default function ContactSection() {
  ...
  return (
   <section 
      id="contact" 
      className="w-full bg-[var(--bg-section)] py-10 lg:py-24 px-6 md:px-11 min-h-screen  flex flex-col justify-center aligns-center"
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 sm:gap-[156px] w-full mx-auto mt-12 items-center">
        {/* Left: intro + sales info */}
        <div className="px-0 sm:px-2 lg:px-1 sm:py-24 sm:py-8"> 
        ...
        <div className="mt-12  bg-[var(--bg-card)] border-[1px]  border-[rgba(255,255,255,0.1)] px-10 py-8">
